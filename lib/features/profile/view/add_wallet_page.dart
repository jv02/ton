...
class WalletSelector extends StatelessWidget {
  ...
  Widget loadUrl() {
    return const WebViewPlus(
      // initialFile: 'assets/demo-dapp-master/scripts/start.js',
      serverPort: 5353,
      javascriptChannels: null,
      javascriptMode: JavascriptMode.unrestricted,
      initialUrl: 'assets/demo-dapp-master/scripts/start.js',
      // initialOptions: InAppWebViewGroupOptions(
      //   crossPlatform: InAppWebViewOptions(
      //     debuggingEnabled: true,
      //     useOnDownloadStart: true
    ...
    return InkWell(
      onTap: () async {
        if (name.toLowerCase() == 'TON Wallet'.toLowerCase() ||
          ...
          // WebView(
          //   initialFile: 'google.com',
          //   initialOptions: JavaScriptMode.unrestricted,
          // )
